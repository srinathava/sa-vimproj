...
if !exists("g:DirDiffExcludes")
    let g:DirDiffExcludes = "CVS,swp$,exe$,obj$"
endif
...
if !exists("g:DirDiffCmdOpts")
    let g:DirDiffCmdOpts = "-r --brief"
endif
...
function! <SID>Copy(fileFrom, fileTo)
    let fileFrom = substitute(a:fileFrom, '\\', '/', 'g')
    let fileTo = substitute(a:fileTo, '\\', '/', 'g')
